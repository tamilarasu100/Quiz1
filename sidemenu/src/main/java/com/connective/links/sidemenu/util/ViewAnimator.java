package com.connective.links.sidemenu.util;
...
import com.connective.links.sidemenu.R;
import com.connective.links.sidemenu.animation.FlipAnimation;
...
public class ViewAnimator<T extends Resourceble> {
    ...
    private com.connective.links.sidemenu.interfaces.ScreenShotable screenShotable;
    private DrawerLayout drawerLayout;
    private ViewAnimatorListener animatorListener;

    public ViewAnimator(Activity activity, List<T> items, com.connective.links.sidemenu.interfaces.ScreenShotable screenShotable, final DrawerLayout drawerLayout, ViewAnimatorListener animatorListener){
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            ((TextView) viewMenu.findViewById(R.id.menu_item_text)).setText(list.get(i).getMenu_name());
    ...
    public interface ViewAnimatorListener {
        ...
        public com.connective.links.sidemenu.interfaces.ScreenShotable onSwitch(Resourceble slideMenuItem, com.connective.links.sidemenu.interfaces.ScreenShotable screenShotable, int position);
